    ...
    <section className="body-font">
      <div className="p-5 mt-3 mx-auto md:mt-5 md:mx-10 lg:mx-16">
        ...
        <div className="mx-auto flex lg:flex-row flex-col items-center justify-center">
          <div data-aos="fade-right" data-aos-duration="1000" data-aos-once="false" className="lg:max-w-lg sm:w-2/3 lg:w-1/2 w-full mb-10 md:mb-0">
            <img className="object-cover object-center rounded backdrop-contrast-200 backdrop-brightness-200" alt="hero" src={require("../assets/Images/about.png")}/>
          </div>
          <div className="lg:w-1/2 justify-center lg:p-5 xl:p-7 md:p-5 flex flex-col items-center text-justify">
            <p data-aos="zoom-in-up" data-aos-duration="1000" data-aos-once="false" className="font-medium text-gray-700 text-lg xl:text-xl leading-loose xl:leading-8">
