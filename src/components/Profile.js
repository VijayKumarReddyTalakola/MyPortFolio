    ...
    <section className="text-gray-600 body-font pt-16">
      <div className="p-5 mx-auto gap-2 flex flex-col md:pt-12 md:px-7 lg:py-20 lg:flex-row-reverse items-center min-h-fit">
        <div data-aos="zoom-in-up" data-aos-duration="1000" data-aos-once="false" className="w-5/6 sm:max-w-xs md:max-w-sm lg:max-w-md sm:w-2/6 lg:mr-10 xl:mr-20 lg:p-5 lg:w-1/3 xl:w-1/4 ">
          <img className="object-cover border-2 border-white cursor-pointer rounded-full sm:hover:scale-110 transition duration-1000 ease-in-out backdrop-contrast-200 backdrop-brightness-200" alt="hero" src={require("../assets/Images/Me.jpg")}/>
        </div>
