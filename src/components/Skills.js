  ...
  return (
    <section className="text-gray-600 body-font">
      <div className="p-4 mx-auto md:px-5 md:py-10 md:mx-20 lg:mx-32 xl:mx-56">
        ...
        <div className="text-center flex justify-center flex-wrap border-t-gray-200  border-2 shadow-xl gap-5 px-2 py-4 md:p-5 md:gap-7 lg:gap-5 lg:p-5 xl:gap-10 xl:p-9">
          {SkillsData.map((Skill) => {
            return (
              <div data-aos="zoom-in-up" data-aos-duration="1000" data-aos-once="false" key={Skill.id} className="flex flex-col m-1 w-20 h-20 items-center justify-center text-center md:w-24 md:h-24 lg:m-3 xl:m-5 ">
